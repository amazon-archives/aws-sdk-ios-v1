...
+(void)waitForTable:(NSString *)tableName toTransitionToStatus:(NSString *)toStatus
{
    ...
    do {
        ...
        DynamoDBDescribeTableRequest *request = [[[DynamoDBDescribeTableRequest alloc] initWithTableName:tableName] autorelease];
...
+(BOOL)setupTables 
{
    ...
    @try {
        //Create Table
        DynamoDBKeySchemaElement *hashKey = [[[DynamoDBKeySchemaElement alloc] init] autorelease];
        ...
        DynamoDBProvisionedThroughput *provisionedThroughput = [[[DynamoDBProvisionedThroughput alloc] init] autorelease];
        ...
        DynamoDBCreateTableRequest *ctr = [[[DynamoDBCreateTableRequest alloc] init] autorelease];
