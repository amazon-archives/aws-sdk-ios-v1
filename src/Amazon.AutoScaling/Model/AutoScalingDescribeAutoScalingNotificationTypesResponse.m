...
-(NSString *)description
{
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[[NSString alloc] initWithFormat:@"AutoScalingNotificationTypes: %@,", autoScalingNotificationTypes] autorelease]];
...
-(void)dealloc
{
    [autoScalingNotificationTypes release];
