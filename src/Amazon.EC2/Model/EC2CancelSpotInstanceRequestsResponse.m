...
-(NSString *)description
{
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[[NSString alloc] initWithFormat:@"CancelledSpotInstanceRequests: %@,", cancelledSpotInstanceRequests] autorelease]];
...
-(void)dealloc
{
    [cancelledSpotInstanceRequests release];
