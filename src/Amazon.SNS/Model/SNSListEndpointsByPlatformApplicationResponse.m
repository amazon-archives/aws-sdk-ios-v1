...
@implementation SNSListEndpointsByPlatformApplicationResponse
...
{
    if (self = [super init]) {
        endpoints = [[NSMutableArray alloc] initWithCapacity:1];
        nextToken = nil;
    }
...
{
    return (SNSEndpoint *)[endpoints objectAtIndex:index];
}
...
-(NSString *)description
{
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[[NSString alloc] initWithFormat:@"Endpoints: %@,", endpoints] autorelease]];
