 ...
 *         returned by AmazonSecurityTokenService.
 * 
 *
 ...
 *             If an error response is returned by AmazonSecurityTokenService indicating
 ...
 *         returned by AmazonSecurityTokenService.
 * 
 * @throws SecurityTokenServicePackedPolicyTooLargeException
 * @throws SecurityTokenServiceMalformedPolicyDocumentException
 *
 * @throws AmazonClientException
 *             If any internal errors are encountered inside the client while
 *             attempting to make the request or handle the response.  For example
