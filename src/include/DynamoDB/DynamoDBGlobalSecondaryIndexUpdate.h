...
@interface DynamoDBGlobalSecondaryIndexUpdate:NSObject

{
    DynamoDBUpdateGlobalSecondaryIndexAction *update;
}
 ...
 */
@property (nonatomic, retain) DynamoDBUpdateGlobalSecondaryIndexAction *update;
