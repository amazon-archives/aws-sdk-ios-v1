...
@implementation DynamoDBGlobalSecondaryIndexDescription

@synthesize indexName;
@synthesize keySchema;
@synthesize projection;
@synthesize indexStatus;
...
-(NSString *)description
{
    ...
    [buffer appendString:[[[NSString alloc] initWithFormat:@"IndexStatus: %@,", indexStatus] autorelease]];
